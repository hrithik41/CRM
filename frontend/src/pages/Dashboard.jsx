...
const Dashboard = () => {
  ...
  const recentDeals = [
    { id: 1, client: 'Acme Corp', contact: 'Alice Smith', amount: '$12,500', stage: 'Proposal Sent', date: '2 hours ago', status: 'warning' },
    { id: 2, client: 'Globex Holdings', contact: 'Bob Johnson', amount: '$34,000', stage: 'Negotiation', date: '5 hours ago', status: 'warning' },
    { id: 3, client: 'Initech Solutions', contact: 'Peter Gibbons', amount: '$8,200', stage: 'Closed Won', date: '1 day ago', status: 'success' },
    { id: 4, client: 'Hooli Inc', contact: 'Gavin Belson', amount: '$150,000', stage: 'Contract Signing', date: '2 days ago', status: 'warning' },
    { id: 5, client: 'Veer Industries', contact: 'Sarah Connor', amount: '$22,500', stage: 'Closed Lost', date: '3 days ago', status: 'danger' },
  ]
  ...
  return (
    <div className="animate-slide-up flex flex-col min-h-full bg-slate-50">
      ...
      <div className="flex flex-col bg-white border-b border-slate-200 w-full shadow-sm z-10 relative">
        {/* Top Div: Banner */}
        <div className="bg-[#B44B00] text-white px-8 py-5">
   ...
   {formattedDate} • {user ? user.name : "Loading..."} • {user ? user.department : "Loading..."}
        ...
        <div className="flex flex-col px-8 py-3 text-sm text-slate-600 border-t border-slate-200 bg-[#F8FAFC]">
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-3 text-xs font-semibold text-slate-500">
            <button className="text-blue-600 border-b-2 border-blue-600 pb-1 -mb-1 cursor-pointer">Today</button>
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">Yesterday</button>
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">This Week</button>
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">Last Week</button>
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">This Month</button>
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">Last Month</button>
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">This FY (2026)</button>
            ...
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">Q1 Apr-Jun</button>
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">Q2 Jul-Sep</button>
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">Q3 Oct-Dec</button>
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">Q4 Jan-Mar</button>
            
            <div className="h-4 w-px bg-slate-300 mx-2"></div>
            
            <button className="hover:text-blue-600 pb-1 -mb-1 transition-colors cursor-pointer">Last FY (2025)</button>
            
            <div className="flex items-center gap-3 ml-auto">
              <input type="text" placeholder="From" className="border border-slate-300 rounded px-3 py-1.5 w-28 outline-none focus:border-blue-500 shadow-sm" />
              <input type="text" placeholder="To" className="border border-slate-300 rounded px-3 py-1.5 w-28 outline-none focus:border-blue-500 shadow-sm" />
              <button className="bg-[#0070c0] hover:bg-blue-700 text-white px-6 py-1.5 rounded text-xs font-bold transition-colors cursor-pointer shadow-sm">Apply</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 md:p-6 w-full space-y-4">
        ...
        <div className="flex items-center gap-4 mb-1">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold text-slate-600 tracking-widest uppercase">Sponsorship</h2>
          </div>
